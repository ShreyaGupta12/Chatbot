...
Original file is located at
    https://colab.research.google.com/drive/1AGxuB3ooiyUBBwPkFw0y3vbFIpes7LPB
...
flag=True
print("ROBO: My name is Robo. I will answer your queries about radioactive radiations. If you want to exit, type Bye!")
while(flag==True):
    user_response = input()
